...
public class SysSecurityGroupController {
    ...
    @AdminApiCheck
    @RequestMapping(value = "/securityGroup/update", method = {RequestMethod.POST, RequestMethod.PUT})
    ...
    @AdminApiCheck
    @RequestMapping(value = "/securityGroup/delete", method = {RequestMethod.POST, RequestMethod.DELETE})
    ...
    @AdminApiCheck
    @PostMapping("/securityGroup/rule/add")
    ...
    @AdminApiCheck
    @RequestMapping(value = "/securityGroup/rule/update", method = {RequestMethod.POST, RequestMethod.PUT})
    ...
    @AdminApiCheck
    @RequestMapping(value = "/securityGroup/rule/delete", method = {RequestMethod.POST, RequestMethod.DELETE})
    ...
    @AdminApiCheck
    @GetMapping("/securityGroup/rule/list")
    ...
    @AdminApiCheck
    @RequestMapping(value = "/securityGroup/apply", method = {RequestMethod.POST, RequestMethod.PUT})
    public Object bindVm(@RequestBody SecurityGroupBindParams params) throws UnauthorizedException {
    ...
    @AdminApiCheck
    @RequestMapping(value = "/securityGroup/unapply", method = {RequestMethod.POST, RequestMethod.DELETE})
    public Object unbindVm(@RequestBody SecurityGroupBindParams params) throws UnauthorizedException {
    ...
    @AdminApiCheck
    @RequestMapping(value = "/securityGroup/sync", method = {RequestMethod.POST, RequestMethod.PUT})
    ...
    @AdminApiCheck
    @GetMapping("/securityGroup/check")
